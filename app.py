...
# =============== CUSTOM CSS FOR BABY BLUE BACKGROUND AND CENTERED BUTTONS ==================
st.markdown("""
    <style>
    ...
    /* Disclaimer styling - white text on baby blue */
    .disclaimer-text {
        text-align: center;
        color: white;
...
if predict_btn:
    ...
    if all(v == 0 for v in [pregnancies, glucose, blood_pressure, skin_thickness, insulin, bmi, dpf, age]):
        ...
        try:
            ...
            if prediction == 1:
                st.markdown("### HIGH DIABETES RISK DETECTED")
